        ...
        extends AbstractTestQueries
{
    ...
    /// TODO: Create issue and link to UDF issimo issue, to implement this test and make sure it passes as POC.
    /// apply needed to test UDFs once it is supported, to test UDF changes with apply once it is implemented.
    @Override
    @Test(enabled = false)
    ...
    /// reduce_agg does not support NULL as init value in Presto C++. the return values are updated. See Presto C++ limitations here:
    /// https://prestodb.io/docs/current/presto_cpp/limitations.html.
    @Override
    @Test
    ...
    /// See Presto C++ limitations here: https://prestodb.io/docs/current/presto_cpp/limitations.html. Modified the results to be consistent.
    @Override
    @Test
    ...
    /// See issue: https://github.com/prestodb/presto/issues/24402.
    @Override
    @Test(enabled = false)
    public void testArrayCumSumDecimals() {}

    /// array_cum_sum does not support Varchar arrays as inputs, the error message however differs in Presto C++ and
    /// Presto (Java).
    @Override
    @Test
    ...
    /// See issue: https://github.com/prestodb/presto/issues/24409.
    @Override
    @Test
    ...
    /// See issue: https://github.com/prestodb/presto/issues/18849.
    @Override
    @Test
...
//        assertQuery("SELECT (SELECT avg(totalprice) FROM orders GROUP BY custkey, orderdate HAVING avg(totalprice) < a) FROM (VALUES 900) t(a)");
    ...
    /// See issue: https://github.com/prestodb/presto/issues/21332.
    @Override
    @Test(enabled = false)
